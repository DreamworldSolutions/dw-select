    ...
    return [
      ...
      css`
        ...
        .header .dialog-header .back-icon {
          height: var(--dw-select-dialog-header-back-icon-width, 40px);
          width: var(--dw-select-dialog-header-back-icon-height, 40px);
          padding: var(--dw-select-dialog-header-back-icon-padding, 0);
          margin: var(--dw-select-dialog-header-back-icon-margin, 0px -4px 0px 0px);
        }

        .header .dialog-header .back-icon > svg {
          height: var(--dw-select-dialog-header-back-icon-svg-width, 24px);
          width: var(--dw-select-dialog-header-back-icon-svg-height, 24px);
          fill: var(--dw-select-dialog-header-back-icon-svg-fill-color);
          padding: var(--dw-select-dialog-header-back-icon-svg-padding, 8px);
          margin: var(--dw-select-dialog-header-back-icon-svg-margin, 0);
        }
