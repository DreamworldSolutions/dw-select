...
| ------------------ | ------------------ | ------------------ | ----------- |
| `selected`         | `dw-list-item`     | `{value, item}`    | Fired when the user changed selection. It’s NOT dispatched when user selects the same value as the current. **DEPRECATED! use `change` instead.** |
| `change`           | `dw-list-item`     | `{value, item}`    | Fired when the user changed selection. It’s NOT dispatched when user selects the same value as the current. |
